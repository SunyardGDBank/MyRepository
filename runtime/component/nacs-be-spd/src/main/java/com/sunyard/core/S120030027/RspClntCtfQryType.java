...
/**
 * <p>RspClntCtfQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspClntCtfQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="CtfInfo" type="{http://esb.spdbbiz.com/services/S120030027}CtfInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspClntCtfQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspClntCtfQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "CtfInfo")
        protected List<CtfInfoType> ctfInfo;
        ...
        /**
         * Gets the value of the ctfInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the ctfInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getCtfInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<CtfInfoType> getCtfInfo() {
            if (ctfInfo == null) {
                ctfInfo = new ArrayList<CtfInfoType>();
            }
            return this.ctfInfo;
        }
