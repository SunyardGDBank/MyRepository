...
/**
 * <p>RspRelPersonQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspRelPersonQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="RelClntInfo" type="{http://esb.spdbbiz.com/services/S120030027}RelClntInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspRelPersonQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspRelPersonQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "RelClntInfo")
        protected List<RelClntInfoType> relClntInfo;
        ...
        /**
         * Gets the value of the relClntInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the relClntInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getRelClntInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RelClntInfoType }
         * 
         * 
         */
        public List<RelClntInfoType> getRelClntInfo() {
            if (relClntInfo == null) {
                relClntInfo = new ArrayList<RelClntInfoType>();
            }
            return this.relClntInfo;
        }
