...
/**
 * <p>RspClntAdrQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspClntAdrQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="AdrInfo" type="{http://esb.spdbbiz.com/services/S120030027}AdrInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspClntAdrQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspClntAdrQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "AdrInfo")
        protected List<AdrInfoType> adrInfo;
        ...
        /**
         * Gets the value of the adrInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the adrInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getAdrInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<AdrInfoType> getAdrInfo() {
            if (adrInfo == null) {
                adrInfo = new ArrayList<AdrInfoType>();
            }
            return this.adrInfo;
        }
