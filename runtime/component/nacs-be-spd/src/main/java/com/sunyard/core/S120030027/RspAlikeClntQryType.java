...
/**
 * <p>RspAlikeClntQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspAlikeClntQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                     &lt;/complexType&gt;
 *                   &lt;/element&gt;
 *                   &lt;element name="AlikeClntInfo" type="{http://esb.spdbbiz.com/services/S120030027}AlikeClntInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspAlikeClntQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspAlikeClntQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "AlikeClntInfo")
        protected List<AlikeClntInfoType> alikeClntInfo;
        ...
        /**
         * Gets the value of the alikeClntInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the alikeClntInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getAlikeClntInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AlikeClntInfoType }
         * 
         * 
         */
        public List<AlikeClntInfoType> getAlikeClntInfo() {
            if (alikeClntInfo == null) {
                alikeClntInfo = new ArrayList<AlikeClntInfoType>();
            }
            return this.alikeClntInfo;
        }
