...
/**
 * <p>RspFncInfoQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspFncInfoQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="FncInfo" type="{http://esb.spdbbiz.com/services/S120030027}FncInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspFncInfoQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspFncInfoQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "FncInfo")
        protected List<FncInfoType> fncInfo;
        ...
        /**
         * Gets the value of the fncInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the fncInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getFncInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<FncInfoType> getFncInfo() {
            if (fncInfo == null) {
                fncInfo = new ArrayList<FncInfoType>();
            }
            return this.fncInfo;
        }
