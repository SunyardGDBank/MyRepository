...
/**
 * <p>RspRiskInfoQryType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RspRiskInfoQryType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="RiskLevelInfo" type="{http://esb.spdbbiz.com/services/S120030027}RiskLevelInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "RspRiskInfoQryType", propOrder = {
    "rspSvcHeader",
    "svcBody"
})
public class RspRiskInfoQryType {
    ...
    public static class SvcBody {
        ...
        @XmlElement(name = "RiskLevelInfo")
        protected List<RiskLevelInfoType> riskLevelInfo;
        ...
        /**
         * Gets the value of the riskLevelInfo property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the riskLevelInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getRiskLevelInfo().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RiskLevelInfoType }
         * 
         * 
         */
        public List<RiskLevelInfoType> getRiskLevelInfo() {
            if (riskLevelInfo == null) {
                riskLevelInfo = new ArrayList<RiskLevelInfoType>();
            }
