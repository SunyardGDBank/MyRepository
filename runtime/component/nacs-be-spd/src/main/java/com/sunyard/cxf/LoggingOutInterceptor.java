...
public class LoggingOutInterceptor extends AbstractLoggingInterceptor {
    ...
    private static LoggingOutInterceptor instance = null;
    
    public static AbstractLoggingInterceptor getInstance(){
        if (instance == null){
            instance = new LoggingOutInterceptor();
        }
        return instance;
    }
    ...
    private LoggingMessage setupBuffer(Message message) {
        ...
        if (responseCode != null) {
            buffer.getEncoding().append(responseCode);
        }
        ...
        if (httpMethod != null) {
            buffer.getContentType().append(httpMethod);
        }
