...
import com.sunyard.sdk.LogUtil;
...
public class Form10_6_5_BatchDF extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		//示例文件位置在src/assets下
		data.put("fileContent", AcpService.enCodeFileContent("D://workspace//ACPSample_DaiFu//src//assets//DF00000000777290058110097201507140002I.txt",DemoBase.encoding));
