...
public class EntityJavaUtil {
    ...
    public static class EntityInfo {
        ...
        /**
         *  spreading code：
         *  新增 sequencePrimaryName primaryStartSequence 屬性
         */
        public final String sequencePrimaryName;
        public final long primaryStartSequence;
        ...
        EntityInfo(EntityDefinition ed, boolean memberNeverCache) {
            ...
            /**
             * spreading code：
             * sequence-primary-name ， primary-start-sequence
             * 扩展entity标签的属性，以动态实现生成实体序列ID
             */
            String spnAttr = internalEntityNode.attribute("sequence-primary-name");
            if(spnAttr == null) spnAttr = ed.getFullEntityName();
            sequencePrimaryName = spnAttr;

            String psqAttr = internalEntityNode.attribute("primary-start-sequence");
            if(psqAttr != null && !psqAttr.isEmpty()) primaryStartSequence = Long.parseLong(psqAttr);
            else primaryStartSequence = 100000;
