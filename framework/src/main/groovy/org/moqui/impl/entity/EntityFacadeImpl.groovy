...
class EntityFacadeImpl implements EntityFacade {
    ...
    */
     ...
     * 动态生成实体序列
     * @param ed
     * @param entityPrimaryName
     * @return
     */
    String dynamicSequencedIdPrimaryEd(EntityDefinition ed,String entityPrimaryName) {
        EntityJavaUtil.EntityInfo entityInfo = ed.entityInfo
        try {
            if (entityInfo.sequencePrimaryUseUuid) return UUID.randomUUID().toString()
        } catch (EntityException e) {
        ...
        // fall through to default to the db sequenced ID
        return dbSequencedIdPrimary(entityPrimaryName,entityInfo.sequencePrimaryStagger, entityInfo.sequenceBankSize,entityInfo.primaryStartSequence)
    }

    /**
     *spreading code：
     * 扩展实体序列生成实现，动态起始流水，动态seqName
     * @param seqName
     * @param staggerMax
     * @param bankSize
     * @param startSeqId
     * @return
     */
    protected String dbSequencedIdPrimary(String seqName, long staggerMax, long bankSize, long startSeqId) {
    ...
    /**
     * spreading code：
     * 新增fieldTypeIntMap 元素  "dropdown-indicator":1
     * 新增fieldTypeJavaMap 元素 "dropdown-indicator":"java.lang.String"
     */
    protected static final Map<String, Integer> fieldTypeIntMap = [
            "id":1, "id-long":1, "text-indicator":1, "dropdown-indicator":1,"text-short":1, "text-medium":1, "text-long":1, "text-very-long":1,
    ...
    protected static final Map<String, String> fieldTypeJavaMap = [
            ...
            "text-indicator":"java.lang.String", "dropdown-indicator":"java.lang.String","text-short":"java.lang.String", "text-medium":"java.lang.String",
